...
const SELF_IMPROVE_ACTION_RE=/\b(make|do|perform|implement|apply|fix|improve|refactor|change|update)\b[\s\S]{0,80}\b(?:\d+\s+)?(?:self[- ]?improvements?|improvements?|fixes?|changes?)\b/i;
