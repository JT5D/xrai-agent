...
The evaluator supplies internal estimates, not execution proof. Browser conversation turns use bounded history and never promote a model score to proof. Sandbox patches are not committed or deployed.
